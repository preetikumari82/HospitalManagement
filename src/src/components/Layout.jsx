...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Sidebar - desktop */}
      <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-line bg-white h-screen sticky top-0 overflow-hidden">
        <Brand />
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <aside className="relative z-50 flex h-full w-64 flex-col bg-white animate-fade-in overflow-hidden">
            <Brand />
            <nav className="flex-1 min-h-0 overflow-y-auto px-3 py-4 space-y-1">
              {nav.map((item) => (
                <NavLink
